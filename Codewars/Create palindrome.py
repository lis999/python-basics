# add numbers to existing list to create a palindrome
...
print('Initial list is: ', nums)
print('Numbers needed to build a palindrome: ', len(answer))
print('List of that numbers: ', answer)
