...
# FUNCTIONS с позиционными (positional) аргументами
...
# print(pattern(char1 = '0', length = 3))
#...........................................................................


# ПРОСТРАНСТВО ИМЕН (SCOPE) global & local arguments
# x = 15
# y = 78
# def sum_it(x, y):
...
# def take_odd(num):
#     if isinstance(num, int) and num%2:          #num%2 - нечетное
#         return True
#     return False
